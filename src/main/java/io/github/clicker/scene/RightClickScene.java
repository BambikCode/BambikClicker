...
public final class RightClickScene extends AnchorPane {

    private final Text cpsText;
    private final Text sceneText;
    private final RightClickerTask rightClickerTask = Main.getInstance().getClickerManager().getRightClickerTask();


    public RightClickScene(SceneManager sceneManager) {
        new Scene(this);
        ...
        sceneText.setText("Prawy przycisk myszy");
    ...
    private Slider configureSlider() {
        ...
        slider.valueProperty().addListener((ov, old, newNum) -> {
            ...
            rightClickerTask.setDelay(newNum.intValue());
        });
        slider.setValue(1);
